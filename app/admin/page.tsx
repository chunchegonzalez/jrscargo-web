    ...
    <div className="space-y-8 animate-fade-in text-sm">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h1 className="text-2xl font-light text-gray-600">
          Buenas noches, <strong className="font-black text-brand-blue">{currentUser?.username || 'Usuario'} !</strong>
        </h1>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3 text-xs">
        ...
        {currentUser?.role === 'admin' && (
          <>
            <Link href="/admin/facturacion/nueva" className="px-4 py-2 bg-white border border-gray-200 rounded-full hover:bg-gray-50 hover:border-gray-300 transition-colors text-brand-blue font-medium">
              Crear factura a clientes
            </Link>
            <Link href="/admin/clientes" className="px-4 py-2 bg-white border border-gray-200 rounded-full hover:bg-gray-50 hover:border-gray-300 transition-colors text-brand-blue font-medium">
              Crear cliente
            </Link>
          </>
        )}
